  ...
  const deleteSelectedRows = async () => {
    ...
    try {
      ...
      const promises = selectedRows.map((id) =>
        axios.delete(
          `https://safety-features.onrender.com/api/place/deleteplace/${id}`
        )
      );
                ...
                <div class="py-3 px-4 flex flex-row items-center justify-between ">
                  ...
                  <div className="flex gap-5 flex-row justify-center items-center">
                    ...
                    <button
                      ...
                      className="bg-[#F44336] py-3 pl-3 pr-4  flex justify-center items-center text-sm font-medium gap-2 rounded-lg text-[#FDEBEA]"
                    >
                    ...
                    <thead class="bg-[#FCFCFD] ">
                      <tr>
                        <th scope="col" class="py-3 px-4 pe-0">
                          <div
                            class="flex items-center  w-5 h-5 hover:cursor-pointer"
                            ...
                            <td class="py-3 ps-4">
                              <div class="flex items-center h-5">
                                <input
                                  ...
                                  onChange={() =>
                                    handleNonObjectCheckboxChange(index)
                                  }
                                />
                              </div>
                            </td>
                            ...
                            <td class="py-3 ps-4">
                              <div class="flex items-center h-5">
                                <input
                                  ...
                                  checked={checkedRows[index]}
                                  onChange={() =>
                                    handleObjectCheckboxChange(index, row?._id)
                                  }
                                />
                                <label
